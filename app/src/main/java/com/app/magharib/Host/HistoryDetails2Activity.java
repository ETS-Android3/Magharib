...
public class HistoryDetails2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void intiViews() {
        ...
        // عمل فحص اذا الهوست قيم او لا اذا قيم يتم اخفاء زر التقييم اذا لم يقيم يتم اظهار زر التقييم
        if (order_details.getIs_host_rating().equals("0")){
    ...
    private void DialogRating() {
        dialog_rating = new Dialog(HistoryDetails2Activity.this, R.style.SheetDialog);
    ...
    public void RatingOrder(String comment) {
        ...
        Constants.showProgress(HistoryDetails2Activity.this);
